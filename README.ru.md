...
<h2 align="center">евалы (WIP, клод дорогой лол)</h3>

tldr: 8 настоящих багов из моих проектов. встроенный `/code-review` нашёл 3, `multi` нашёл 6. одни и те же баги, один и тот же чекаут, оба на sonnet.
